...
namespace Sous_Cloud_Pantry.Controllers
{
    public class MeasurementsController : Controller
    {
        ...
        public MeasurementsController(SousKitchenPantryDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MeasurementId,MeasurementMethod")] Measurement measurement)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MeasurementId,MeasurementMethod")] Measurement measurement)
        {
